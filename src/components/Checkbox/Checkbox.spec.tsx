...
describe('Checkbox', () => {
  ...
  it('should render the children options when provided', () => {
    const mockOnChange = jest.fn();
    render(<Checkbox option={{ name: 'option', children: <div>Children option</div> }} onChange={mockOnChange} />);
